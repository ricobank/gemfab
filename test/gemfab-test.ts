...
describe('gemfab', () => {
  ...
  describe('gas cost', () => {
    ...
    it('mint 0', async() => {
      ...
      await check(gas, 30982, 30982);
    })

    it('mint', async () => {
      const gas = await gem.estimateGas.mint(ALI, 100);
      await check(gas, 70318, 70318);
    });
